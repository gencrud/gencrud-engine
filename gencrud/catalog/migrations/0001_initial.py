# Generated by Django 4.0.4 on 2022-04-13 11:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('pcs', 'шт.'), ('m', 'п.м'), ('sqm', 'м.кв'), ('cbm', 'м.куб'), ('not_show', ' - ')], default='pcs', max_length=12, verbose_name='Ед.изм')),
            ],
            options={
                'verbose_name': 'Прайс',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommend_products', models.ManyToManyField(blank=True, help_text='Отображаются внизу карточки товара, как рекомендованные или похожие товары', limit_choices_to={'is_show': True}, to='catalog.product', verbose_name='Рекомендованные/Похожие')),
                ('tags', models.ManyToManyField(blank=True, to='site_info.tag', verbose_name='Тэги')),
            ],
            options={
                'verbose_name': 'Товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bool_value', models.BooleanField(max_length=255, null=True, verbose_name='Значение(булево)')),
